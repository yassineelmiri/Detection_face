...
cap = cv2.VideoCapture(0)  # Utilisez 0 pour la caméra intégrée
cap.set(3, wCam)
cap.set(4, hCam)
pTime = 0

# Utilisez un float pour detectionCon
...
while True:
    ...
    if len(lmList) != 0:
        ...
        # Dessine les cercles et la ligne entre les doigts
    ...
    cv2.imshow("Img", img)  # Montre la vidéo
